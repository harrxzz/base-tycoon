...
export default function PrestigeRoute() {
  return (
    <section className="mx-auto max-w-3xl px-4 py-12">
      <Card className="relative overflow-hidden border-base-blue/30 bg-gradient-to-br from-base-blue/10 via-card to-card">
        ...
        <CardContent className="relative flex flex-col items-center gap-5 p-12 text-center">
          <div className="grid size-14 place-items-center rounded-2xl bg-amber-500/15 text-amber-400">
            <Crown />
          </div>
